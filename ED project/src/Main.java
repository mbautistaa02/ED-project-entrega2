...
public class Main {
    ...
    public List<prenda> buscarProductos(Scanner sc) {
        System.out.println("Inserta tú busqueda");
       ...
       printresult(resultados);
        ordFilt(sc,resultados);
        return resultados;
    }
    public void ordFilt(Scanner sc,List<prenda> resultados){
        ...
        switch (respuesta) {
            ...
            case "2":
                ...
                //filtrado.testPerformance(allP, 0, 50000 , 10);
                break;
            case "3":
                cont = false;
                break;
    ...
    public void printresult(List<prenda>resultados){
